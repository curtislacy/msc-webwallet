...
def parse():
    ...
    parser.add_option( "-r", "--repository-path", dest='repository_path', default="~/omniwallet", 
                        help="Specify the location of the omniwallet repository (defaults to ~/omniwallet" )
